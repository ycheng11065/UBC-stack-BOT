...
#   embed.add_field(name='choose 2 of the following', value='[WRDS 150B] (https://courses.students.ubc.ca/cs/courseschedule?pname=subjarea&tname=subj-course&dept=WRDS&course=150B) \n ENGL 110 \n ENGL 111 \n SCIE 113 \n SCIE 300 `(only for combined major in science)` \n CHEM 300 `(only for chemistry majors`', inline=False)
